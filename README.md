if getgenv().hub then warn("Toddynho Fish : Already executed!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Toddynho Fish",
    SubTitle = " (https://discord.gg/b5G6VVAhDN", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/b5G6VVAhDN") -- discord link
        end
    })
